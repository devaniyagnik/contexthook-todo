...
const Signup = () => {
  const { localdata, setLocaldata, isLoggedIn } =
  ...
  const Submitdata = (e) => {
    ...
    if (
      ...
      localdata.filter((e) => e.email === currentUserInput.email).length > 0
    ) {
                  ...
                  <div className="row justify-content-center">
                    <div className="col-md-10 col-lg-6 col-xl-5 order-2 order-lg-1">
                      <p className="text-center h1 fw-bold mb-5 mx-1 mx-md-4 mt-4">
                        {isLoggedIn ? "Add New User " : "Sign up"}
                      </p>
